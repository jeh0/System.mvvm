...
{
    /// <summary> This service shows messages to the user. It returns the answer when the message was a question. </summary>
    ...
    public interface IMessageService
    {
        ...
        void ShowMessage(object _owner, string _message);

        /// <summary> Shows the message as warning. </summary>
        /// <param name="_owner">The window that owns this Message Window.</param>
        /// <param name="_message">The message.</param>
        void ShowWarning(object _owner, string _message);

        /// <summary> Shows the message as error. </summary>
        /// <param name="_owner">The window that owns this Message Window.</param>
        /// <param name="_message">The message.</param>
        void ShowError(object _owner, string _message);
